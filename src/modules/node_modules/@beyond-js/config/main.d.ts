...
declare namespace ns_7 {
   ...
   */
  export class Property extends Property_base {
    #private;
    get dp(): string;
    get id(): string;
    get parent(): Property;
